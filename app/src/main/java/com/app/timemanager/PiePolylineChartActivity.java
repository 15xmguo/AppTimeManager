...
public class PiePolylineChartActivity extends DemoBase implements OnChartValueSelectedListener {
    ...
    private void SetButtonColor() {
        ...
        switch (style) {
            case StatisticsInfo.DAY:
                buttonday.setTextColor(Color.CYAN);
                break;
            case StatisticsInfo.MONTH:
                buttonmonth.setTextColor(Color.CYAN);
                break;
            case StatisticsInfo.WEEK:
                buttonweek.setTextColor(Color.CYAN);
                break;
            case StatisticsInfo.YEAR:
                buttonyear.setTextColor(Color.CYAN);
                break;
        }
    }
    ...
    protected void onResume() {
        ...
        String content  = generateCenterSpannableText(style).toString();
        Log.d("HQS", content);
    ...
    private void setData(int style) {
        ...
        Log.d("HQS", "totalTime: " + totaltime);
        TextView textView =(TextView) findViewById(R.id.textViewchart);
        Log.d("HQS", String.valueOf(DateUtils.formatElapsedTime(totaltime)));
        Log.d("HQS", String.valueOf(DateUtils.formatElapsedTime(totaltime / 1000)));
